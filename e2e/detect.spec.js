...
describe("framework detection", () => {
  it("should detect frameworks", async () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      - samples/app/solid (Vite)
      - samples/app/static (Static HTML)
      - samples/app/stencil (Stencil.js)
      - samples/app/svelte (Svelte)
      - samples/app/svelte-kit (SvelteKit)
      - samples/app/vite-lit (Vite)
      - samples/app/vite-preact (Vite)
      - samples/app/vite-react (Vite)
      - samples/app/vite-svelte (Vite)
      - samples/app/vite-vanilla (Vite)
      - samples/app/vite-vue (Vite)
      - samples/app/vitepress (VitePress)
      - samples/app/vue (Vite)
