import type { TelemetryEventMeasurements, RawTelemetryEventProperties, TelemetryEventProperties } from "./telemetryReporterTypes.js";
import { BaseTelemetrySender } from "./baseTelemetrySender.js";
