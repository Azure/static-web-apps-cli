...
Local authentication and authorization support are key for validating and testing your Static Web App. The CLI allows you to mock and read authentication and authorization credentials.
